...
public class SignupUtils {
    ...
    public static Intent getSignUpIntent(final Activity activity, final boolean toServerChooser) {
        final Intent intent;
        if (toServerChooser) {
            intent = new Intent(activity, MagicCreateActivity.class);//PickServerActivity.class
        } else {
