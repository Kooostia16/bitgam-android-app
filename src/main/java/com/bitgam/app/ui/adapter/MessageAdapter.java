...
import com.bitgam.app.entities.Message.FileParams;
import com.bitgam.app.entities.RtpSessionStatus;
import com.bitgam.app.entities.Transferable;
import com.bitgam.app.http.P1S3UrlStreamHandler;
import com.bitgam.app.persistance.FileBackend;
import com.bitgam.app.services.MessageArchiveService;
import com.bitgam.app.services.NotificationService;
...
import com.bitgam.app.ui.service.AudioPlayer;
import com.bitgam.app.ui.text.DividerSpan;
import com.bitgam.app.ui.text.QuoteSpan;
import com.bitgam.app.ui.util.AvatarWorkerTask;
import com.bitgam.app.ui.util.MyLinkify;
import com.bitgam.app.ui.util.ViewUtil;
import com.bitgam.app.ui.widget.ClickableMovementMethod;
import com.bitgam.app.ui.widget.CopyTextView;
import com.bitgam.app.ui.widget.ListSelectionManager;
import com.bitgam.app.utils.CryptoHelper;
import com.bitgam.app.utils.EmojiWrapper;
import com.bitgam.app.utils.Emoticons;
...
public class MessageAdapter extends ArrayAdapter<Message> implements CopyTextView.CopyHandler {
    ...
    private void displayTextMessage(final ViewHolder viewHolder, final Message message, boolean darkBackground, int type) {
        ...
        /*if (viewHolder.linLayoutReceived != null) {
            viewHolder.linLayoutReceived.setOrientation(LinearLayout.HORIZONTAL);
        } else {
            viewHolder.message_box.setOrientation(LinearLayout.HORIZONTAL);
        }*/
        ...
        if (message.getBody() != null) {
            //ConversationsActivity ctx = (ConversationsActivity) activity;
            //ConversationFragment cvF = (ConversationFragment) ctx.getFragmentManager().findFragmentById(R.id.main_fragment);
            if (type == SENT) {
                viewHolder.messageBody.setMaxWidth( metrics.widthPixels - (int) (84*metrics.density));
            }
            //viewHolder.messageBody.setMaxWidth( metrics.widthPixels - (int) ((84 + viewHolder.messaageInfo.getWidth())*metrics.density));
    ...
    private void displayMediaPreviewMessage(ViewHolder viewHolder, final Message message, final boolean darkBackground) {
        ...
        /*if (viewHolder.linLayoutReceived != null) {
            viewHolder.linLayoutReceived.setOrientation(LinearLayout.VERTICAL);
        } else {
            viewHolder.message_box.setOrientation(LinearLayout.VERTICAL);
        }*/
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            switch (type) {
                ...
                case SENT:
                    ...
                    viewHolder.messaageInfo = view.findViewById(R.id.message_info);
                    break;
                case RECEIVED:
                    ...
                    viewHolder.audioPlayer = view.findViewById(R.id.audio_player);
                    viewHolder.messageNick = view.findViewById(R.id.message_nick);
                    viewHolder.messaageInfo = view.findViewById(R.id.message_info);
                   //viewHolder.linLayoutReceived = view.findViewById(R.id.lin_layout_message_received);
                    break;
                case STATUS:
        ...
        if (type == RECEIVED) {
            ...
            if (message.next() != null) {
                if (message.getCounterpart().equals(message.next().getCounterpart())) {
            ...
            if (message.prev() != null) {
                if (message.getCounterpart().equals(message.prev().getCounterpart())) {
                    viewHolder.messageNick.setVisibility(View.GONE);
                } else {
                    viewHolder.messageNick.setVisibility(View.VISIBLE);
                    viewHolder.messageNick.setText(UIHelper.getMessageDisplayName(message));
                }
            } else {
                viewHolder.messageNick.setVisibility(View.VISIBLE);
                viewHolder.messageNick.setText(UIHelper.getMessageDisplayName(message));
        ...
        /*if (getItem(position-1) != null && getItem(position) != null) {
            if (getItem(position-1).getCounterpart().equals(getItem(position).getCounterpart())) {
                viewHolder.messageNick.setText(UIHelper.getMessageDisplayName(message));
            }
        }*/
    ...
    private static class ViewHolder {
        ...
        protected TextView messageNick;
        protected LinearLayout messaageInfo;
    }
