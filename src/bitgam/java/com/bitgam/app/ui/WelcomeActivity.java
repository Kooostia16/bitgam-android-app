...
import com.bitgam.app.databinding.ActivityWelcomeBinding;
...
import com.bitgam.app.utils.InstallReferrerUtils;
...
public class WelcomeActivity extends XmppActivity implements XmppConnectionService.OnAccountCreated, KeyChainAliasCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        binding.registerNewAccount.setOnClickListener(v -> {
            final Intent intent = new Intent(this, MagicCreateActivity.class);//PickServerActivity
            addInviteUri(intent);
            startActivity(intent);
        });
