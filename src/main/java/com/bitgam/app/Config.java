...
public final class Config {
    ...
    public static final String LOGTAG = "BitGamLOG";//BuildConfig.LOGTAG;

    public static final Jid BUG_REPORTS = Jid.of("bugs@bitgam.im");
    public static final Uri HELP = Uri.parse("https://app.bitgam.im");//"https://help.conversations.im");


    public static final String DOMAIN_LOCK = "bitgam.im"; //only allow account creation for this domain
    public static final String MAGIC_CREATE_DOMAIN = "bitgam.im";
