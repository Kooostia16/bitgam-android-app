...
public class WrappedJid implements com.bitgam.app.xmpp.Jid {
    ...
    @Override
    public com.bitgam.app.xmpp.Jid asBareJid() {
        return new WrappedJid(inner.asBareJid());
    }

    @Override
    public com.bitgam.app.xmpp.Jid withResource(CharSequence resource) {
    ...
    @Override
    public com.bitgam.app.xmpp.Jid getDomain() {
    ...
    @Override
    public int compareTo(com.bitgam.app.xmpp.Jid jid) {
