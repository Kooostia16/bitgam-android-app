...
import com.bitgam.app.services.ExportBackupService;
...
public class SettingsActivity extends XmppActivity implements
	...
	public void onStart() {
		...
		boolean removeLocation = new Intent("com.bitgam.app.location.request").resolveActivity(getPackageManager()) == null;
